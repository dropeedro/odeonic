  ...
  <header class="bg-SecondaryColor sticky top-0 shadow-md px-4 py-2 z-50">
    <div class="flex items-center justify-between max-w-6xl mx-auto">
      ...
      <h1 class="flex-shrink-0">
        <a href="/">
          <img src="../assets/riffname.svg" alt="logo" class="w-32 sm:w-44" />
        </a>
      </h1>
      ...
      <nav class="hidden md:block">
        <ul class="flex items-center space-x-4">
          <li class="p-4 border-b-2 border-PrimaryColor border-opacity-0 hover:border-opacity-100 hover:text-PrimaryColorDark text-PrimaryColor duration-200 cursor-pointer">
            <a href="/">Home</a>
          </li>
          <li class="p-4 border-b-2 border-PrimaryColor border-opacity-0 hover:border-opacity-100 hover:text-PrimaryColorDark text-PrimaryColor duration-200 cursor-pointer">
      ...
      <div class="flex items-center space-x-2">
        <a href="/login" class="text-PrimaryColor hover:text-PrimaryColorDark duration-200">
          <svg class="h-8 sm:h-10 p-1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
