<template>
  <div
    class="min-h-screen flex flex-col items-center justify-center bg-backgroundColor"
  >
    <div class="p-2 rounded-lg max-w-3xl w-full">
      <!-- TITLE -->
      <div class="mx-auto mb-[60px] max-w-[510px] text-center">
        <h2
          class="text-PrimaryColor mb-3 text-3xl leading-[1.208] font-bold text-dark sm:text-4xl md:text-[40px]"
        >
          Let's Generate!
        </h2>
      ...
      <div
        class="flex flex-col lg:flex-row justify-between items-start lg:space-x-4 space-y-6 lg:space-y-0"
      >
        <!-- GENERATE MUSIC -->
        <div class="bg-backgroundColor p-6 rounded-lg w-full max-w-md">
          ...
          <div class="relative mb-4">
            ...
            <div
              class="absolute right-0.5 top-1/2 transform -translate-y-1/2 bg-SecondaryColor p-2 rounded"
            >
          ...
          <button
            @click="playSongBasedOnParameters"
        ...
        <!-- SHARE MUSIC -->
        <div
          class="bg-secondaryWhiteColor p-7 rounded-lg border-2 w-full max-w-md"
        >
          ...
          <button
            ...
            class="bg-plusGrayColor p-2 rounded-md mb-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-12 w-12"
