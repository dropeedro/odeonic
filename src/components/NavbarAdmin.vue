    ...
    <div class="flex items-center justify-between max-w-6xl mx-auto">
      ...
      <nav class="hidden md:block font-semibold text-md">
        <ul class="flex items-center space-x-4 text-PrimaryColor">
          <li
            class="p-4 hover:text-PrimaryColorDark text-PrimaryColor duration-200 cursor-pointer"
          >
      ...
      <div class="flex items-center space-x-2">
        ...
        <!-- Hamburger Menu -->
        <button
          class="md:hidden text-PrimaryColor focus:outline-none"
          @click="toggleMenu"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div v-if="menuOpen" class="md:hidden bg-SecondaryColor py-4">
      <ul class="flex flex-col items-center space-y-2 text-PrimaryColor">
        <li>
          <router-link
            to="/admin"
            class="block py-2 hover:text-PrimaryColorDark"
  ...
  >
    <div class="bg-white p-6 rounded-lg w-80" @click.stop>
      ...
      <div class="flex justify-between">
        <button
          @click="logout"
          class="bg-PrimaryColor text-white px-4 py-2 rounded-lg hover:bg-PrimaryColorDark"
        >
          Sí
        </button>
        <button
