        ...
        <div class="w-full px-4">
          <div
            ...
            <div class="mb-10 text-center md:mb-16">
              <a href="javascript:void(0)" class="mx-auto inline-block max-w-[320px]">
                <img src="../assets/ODEONICLOGO.png" alt="logo" />
              </a>
            </div>
            <form>
              <div class="mb-6">
              ...
              <div class="mb-10">
                <input type="submit" value="Sign In"
                  class="w-full px-5 py-3 text-base font-medium text-black transition border rounded-md cursor-pointer border-primary bg-primary hover:bg-opacity-90" />
              </div>
            </form>
